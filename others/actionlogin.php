...
else
{
    ...
    $query = "SELECT mid, MD5(UNIX_TIMESTAMP() + mid + RAND(UNIX_TIMESTAMP()))
        guid FROM Final_member WHERE email = '$email' AND pwd = '$password'";
    ...
    if (mysqli_num_rows($result))
    {
        ...
        $query = "UPDATE Final_member SET guid = '$row[1]' WHERE mid = '$row[0]'";
    ...
    else
    {
        ...
        header('Refresh:2 ;url= Login_v1/login.php?refer='. urlencode($refer));
    }
}
?>
</body>
